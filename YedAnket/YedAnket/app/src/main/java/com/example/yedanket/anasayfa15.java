...
public class anasayfa15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member = new Member();
        c2 = findViewById(R.id.checkbox151);
        c1 = findViewById(R.id.checkbox152);
        FirebaseUser kullanici = mAuth.getCurrentUser();
        String kullaniciId = kullanici.getUid();
        reference = database.getInstance().getReference().child("Kullanicilar").child(kullaniciId).child("Son 6 Soru").child("15.Soru");
